...
const SelectColor: React.FC<SelectColorsProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 p-2 items-center overflow-y-auto border-b-[1.2px] border-slate-200">
      ...
      <>
        {isSelected && !file && (
          <div className="col-span-2 text-center items-center justify-between">
